...
IS_p5_n25 <- list()
tmp = list()
load("03_IS_Gaussian/1_tuning/dist_best_IS_p5_n25.Rdata")
seeds = 1:50
...
save(IS_p5_n25, file = filenamesave)


### n = 50
IS_p5_n50 <- list()
tmp = list()
load("03_IS_Gaussian/1_tuning/dist_best_IS_p5_n50.Rdata")
seeds = 1:50
...
filenamesave = paste0("03_IS_Gaussian/2_time_effsize/IS_toess_p", p, "_n", n, ".Rdata")
save(IS_p5_n50, file = filenamesave)


### n = 100
IS_p5_n100 <- list()
tmp = list()
load("03_IS_Gaussian/1_tuning/dist_best_IS_p5_n100.Rdata")
seeds = 1:50
...
filenamesave = paste0("03_IS_Gaussian/2_time_effsize/IS_toess_p", p, "_n", n, ".Rdata")
save(IS_p5_n100, file = filenamesave)
...
IS_p5_n200 <- list()
tmp = list()
load("03_IS_Gaussian/1_tuning/dist_best_IS_p5_n200.Rdata")
seeds = 1:50
...
filenamesave = paste0("03_IS_Gaussian/2_time_effsize/IS_toess_p", p, "_n", n, ".Rdata")
save(IS_p5_n200, file = filenamesave)
