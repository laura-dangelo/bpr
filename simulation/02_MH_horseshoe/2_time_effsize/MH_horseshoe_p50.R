...
### n = 25 
MH_horseshoe_p50_n25 <- list()
tmp = list()
seeds = 1:50
load("02_MH_horseshoe/1_tuning/dist_best_MH_p50_n25.Rdata")
tau = est_tau(50, beta_p50)

best_dist[c(6,15,16,21,27,29,36,40,42,47)] = 1e+9

for(seed in c(6,15,16,21,27,29,36,40,42,47))
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_horseshoe_p50_n25[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}
lapply(MH_horseshoe_p50_n25, function(x) x$run$acceptance_rate )
filenamesave = paste0("02_MH_horseshoe/2_time_effsize/MH_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(MH_horseshoe_p50_n25, file = filenamesave)

rm(MH_horseshoe_p50_n25)

### n = 50
MH_horseshoe_p50_n50 <- list()
tmp = list()
seeds = 1:50
load("02_MH_horseshoe/1_tuning/dist_best_MH_p50_n50.Rdata")
tau = est_tau(50, beta_p50)
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_horseshoe_p50_n50[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}
lapply(MH_horseshoe_p50_n50, function(x) x$run$acceptance_rate)
filenamesave = paste0("02_MH_horseshoe/2_time_effsize/MH_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(MH_horseshoe_p50_n50, file = filenamesave)
rm(MH_horseshoe_p50_n50)



### n = 100
MH_horseshoe_p50_n100 <- list()
tmp = list()
seeds = 1:50
load("02_MH_horseshoe/1_tuning/dist_best_MH_p50_n100.Rdata")
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_horseshoe_p50_n100[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("02_MH_horseshoe/2_time_effsize/MH_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(MH_horseshoe_p50_n100, file = filenamesave)
rm(MH_horseshoe_p50_n100)

### n = 200
MH_horseshoe_p50_n200 <- list()
tmp = list()
seeds = 1:50
load("02_MH_horseshoe/1_tuning/dist_best_MH_p50_n200.Rdata")
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_horseshoe_p50_n200[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("02_MH_horseshoe/2_time_effsize/MH_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(MH_horseshoe_p50_n200, file = filenamesave)
