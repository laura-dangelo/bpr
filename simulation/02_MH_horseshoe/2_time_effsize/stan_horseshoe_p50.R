...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_horseshoe_p50_n25[[seed]] <- tmp
...
save(stan_horseshoe_p50_n25, file = filenamesave)


### n = 50
stan_horseshoe_p50_n50 <- list()
tmp = list()
seeds = 1:50
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_horseshoe_p50_n50[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("02_MH_horseshoe/2_time_effsize/stan_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(stan_horseshoe_p50_n50, file = filenamesave)


### n = 100
stan_horseshoe_p50_n100 <- list()
tmp = list()
seeds = 1:50
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_horseshoe_p50_n100[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("02_MH_horseshoe/2_time_effsize/stan_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(stan_horseshoe_p50_n100, file = filenamesave)


### n = 200
stan_horseshoe_p50_n200 <- list()
tmp = list()
seeds = 1:50
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_horseshoe_p50_n200[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("02_MH_horseshoe/2_time_effsize/stan_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(stan_horseshoe_p50_n200, file = filenamesave)
