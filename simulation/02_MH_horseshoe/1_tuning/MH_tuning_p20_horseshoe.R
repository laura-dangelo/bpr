...
save(best_dist, 
     file="02_MH_horseshoe/1_tuning/dist_best_MH_p20_n25.Rdata")

rm(effic_sim_mh_p20_n25)
...
save(best_dist, 
     file="02_MH_horseshoe/1_tuning/dist_best_MH_p20_n50.Rdata")

rm(effic_sim_mh_p20_n50)
...
save(best_dist, 
     file="02_MH_horseshoe/1_tuning/dist_best_MH_p20_n100.Rdata")

rm(effic_sim_mh_p20_n100)
...
save(best_dist, 
     file="02_MH_horseshoe/1_tuning/dist_best_MH_p20_n200.Rdata")

rm(effic_sim_mh_p20_n200)