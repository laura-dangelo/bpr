...
nrep = 1000
burnin <- c(1:500)
dist_seq = sort(rep(seq(50, 500, length.out = 5),3))
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p50_n25.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p50_n50.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p50_n100.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p50_n200.Rdata")
