...
nrep = 2000
burnin <- c(1:1000)
dist_seq = sort(rep(seq(1, 300, length.out = 10),4))
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p10_n25.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p10_n50.Rdata")
...
nrep = 2000
burnin <- c(1:1000)
dist_seq = sort(rep(seq(10, 500, length.out = 10),4))
best_dist = numeric(50)
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p10_n100.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p10_n200.Rdata")
