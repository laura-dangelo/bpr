...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p5_n25.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p5_n50.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p5_n100.Rdata")
...
save(best_dist, 
     file="01_MH_Gaussian/1_tuning/dist_best_MH_p5_n200.Rdata")
