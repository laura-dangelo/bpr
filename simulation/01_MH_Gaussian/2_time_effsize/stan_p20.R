...
save(stan_p20_n25, file = filenamesave)
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_p20_n50[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("01_MH_Gaussian/2_time_effsize/stan_toess_p", p, "_n", n, ".Rdata")
save(stan_p20_n50, file = filenamesave)
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_p20_n100[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("01_MH_Gaussian/2_time_effsize/stan_toess_p", p, "_n", n, ".Rdata")
save(stan_p20_n100, file = filenamesave)
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  stan_p20_n200[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("01_MH_Gaussian/2_time_effsize/stan_toess_p", p, "_n", n, ".Rdata")
save(stan_p20_n200, file = filenamesave)
