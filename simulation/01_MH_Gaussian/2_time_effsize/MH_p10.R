...
MH_p10_n25 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p10_n25.Rdata")
seeds = 1:50
...
save(MH_p10_n25, file = filenamesave)


### n = 50
MH_p10_n50 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p10_n50.Rdata")
seeds = 1:50
...
filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p10_n50, file = filenamesave)


### n = 100
MH_p10_n100 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p10_n100.Rdata")
seeds = 1:50
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_p10_n100[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p10_n100, file = filenamesave)
...
MH_p10_n200 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p10_n200.Rdata")
seeds = 1:50
...
for(seed in seeds)
{
  ...
  tmp$time <- time
  tmp$effSize <- effSize
  MH_p10_n200[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p10_n200, file = filenamesave)
