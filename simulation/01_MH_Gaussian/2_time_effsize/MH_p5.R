...
MH_p5_n25 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p5_n25.Rdata")
seeds = 1:50
...
save(MH_p5_n25, file = filenamesave)


### n = 50
MH_p5_n50 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p5_n50.Rdata")
seeds = 1:50
...
filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p5_n50, file = filenamesave)


### n = 100
MH_p5_n100 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p5_n100.Rdata")
seeds = 1:50
...
filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p5_n100, file = filenamesave)
...
MH_p5_n200 <- list()
tmp = list()
load("01_MH_Gaussian/1_tuning/dist_best_MH_p5_n200.Rdata")
seeds = 1:50
...
filenamesave = paste0("01_MH_Gaussian/2_time_effsize/MH_toess_p", p, "_n", n, ".Rdata")
save(MH_p5_n200, file = filenamesave)
