...
### n = 25 
IS_horseshoe_p10_n25 <- list()
tmp = list()
seeds = 1:50
load("04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p10_n25.Rdata")
...
for(seed in seeds)
{
  ...
  IS_horseshoe_p10_n25[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("04_IS_horseshoe/2_time_effsize/IS_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(IS_horseshoe_p10_n25, file = filenamesave)
rm(IS_horseshoe_p10_n25)


### n = 50
IS_horseshoe_p10_n50 <- list()
tmp = list()
seeds = 1:50
load("04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p10_n50.Rdata")
...
for(seed in seeds)
{
  ...
  IS_horseshoe_p10_n50[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("04_IS_horseshoe/2_time_effsize/IS_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(IS_horseshoe_p10_n50, file = filenamesave)
rm(IS_horseshoe_p10_n50)

### n = 100
IS_horseshoe_p10_n100 <- list()
tmp = list()
seeds = 1:50
load("04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p10_n100.Rdata")
...
for(seed in seeds)
{
  ...
  IS_horseshoe_p10_n100[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("04_IS_horseshoe/2_time_effsize/IS_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(IS_horseshoe_p10_n100, file = filenamesave)
rm(IS_horseshoe_p10_n100)

### n = 200

IS_horseshoe_p10_n200 <- list()
tmp = list()
seeds = 1:50
load("04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p10_n200.Rdata")
...
for(seed in seeds)
{
  ...
  IS_horseshoe_p10_n200[[seed]] <- tmp
  
  if(seed%%10==0) print(seed)
}

filenamesave = paste0("04_IS_horseshoe/2_time_effsize/IS_horseshoe_toess_p", p, "_n", n, ".Rdata")
save(IS_horseshoe_p10_n200, file = filenamesave)
