...
nrep = 1000
burnin <- c(1:500)
dist_seq = sort(rep(c(seq(100, 1000, length.out = 5), 5000, 10000), 3) ) 
...
for(seed in 1:50)
{
  ...
  effic_sim_is_horseshoe_p20_n25 <- list()
  for(d in 1:length(dist_seq))
  {
    ...
    effic_sim_is_horseshoe_p20_n25[[d]] <- w
    
  }

  df = data.frame(dist = dist_seq, 
                  value = unlist(lapply(effic_sim_is_horseshoe_p20_n25, effectiveSize  )) ) 
...
best_dist
save(best_dist, 
     file="04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p20_n25.Rdata")

rm(effic_sim_is_horseshoe_p20_n25)
...
for(seed in 1:50)
{
  ...
  effic_sim_is_horseshoe_p20_n50 <- list()
  for(d in 1:length(dist_seq))
  {
    run <- sample_bpr( y ~ X - 1, data = data.frame("y" = y, X), 
                       iter = nrep,
    ...
    effic_sim_is_horseshoe_p20_n50[[d]] <- w
    
  }
  
  df = data.frame(dist = dist_seq, 
                  value = unlist(lapply(effic_sim_is_horseshoe_p20_n50, effectiveSize  )) ) 
...
save(best_dist, 
     file="04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p20_n50.Rdata")

rm(effic_sim_is_horseshoe_p20_n50)
...
for(seed in 1:50)
{
  ...
  effic_sim_is_horseshoe_p20_n100 <- list()
  for(d in 1:length(dist_seq))
  {
    run <- sample_bpr( y ~ X - 1, data = data.frame("y" = y, X), 
                       iter = nrep,
    ...
    effic_sim_is_horseshoe_p20_n100[[d]] <- w
    
  }
  
  df = data.frame(dist = dist_seq, 
                  value = unlist(lapply(effic_sim_is_horseshoe_p20_n100, effectiveSize  )) ) 
...
save(best_dist, 
     file="04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p20_n100.Rdata")

rm(effic_sim_is_horseshoe_p20_n100)
...
for(seed in 1:50)
{
  ...
  effic_sim_is_horseshoe_p20_n200 <- list()
  for(d in 1:length(dist_seq))
  {
    run <- sample_bpr( y ~ X - 1, data = data.frame("y" = y, X), 
                       iter = nrep,
    ...
    effic_sim_is_horseshoe_p20_n200[[d]] <- w
    
  }
  
  df = data.frame(dist = dist_seq, 
                  value = unlist(lapply(effic_sim_is_horseshoe_p20_n200, effectiveSize  )) ) 
...
save(best_dist, 
     file="04_IS_horseshoe/1_tuning/dist_best_IS_horseshoe_p20_n200.Rdata")

rm(effic_sim_is_horseshoe_p20_n200)
