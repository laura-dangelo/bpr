...
for(seed in seeds)
{
  ...
  filenameX = paste0("X_p20_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p20_n", n, "_seed", seed, ".Rdata")
  save(X_p20_n25, file=filenameX)
  save(y_p20_n25, file=filenamey)
  ...
  filenameX = paste0("X_p20_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p20_n", n, "_seed", seed, ".Rdata")
  save(X_p20_n50, file=filenameX)
  save(y_p20_n50, file=filenamey)
  ...
  filenameX = paste0("X_p20_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p20_n", n, "_seed", seed, ".Rdata")
  save(X_p20_n100, file=filenameX)
  save(y_p20_n100, file=filenamey)
  ...
  filenameX = paste0("X_p20_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p20_n", n, "_seed", seed, ".Rdata")
  save(X_p20_n200, file=filenameX)
  save(y_p20_n200, file=filenamey)
