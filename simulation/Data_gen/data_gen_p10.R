...
for(seed in seeds)
{
  ...
  filenameX = paste0("X_p10_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p10_n", n, "_seed", seed, ".Rdata")
  save(X_p10_n25, file=filenameX)
  save(y_p10_n25, file=filenamey)
  ...
  filenameX = paste0("X_p10_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p10_n", n, "_seed", seed, ".Rdata")
  save(X_p10_n50, file=filenameX)
  save(y_p10_n50, file=filenamey)
  ...
  filenameX = paste0("X_p10_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p10_n", n, "_seed", seed, ".Rdata")
  save(X_p10_n100, file=filenameX)
  save(y_p10_n100, file=filenamey)
  ...
  filenameX = paste0("X_p10_n", n, "_seed", seed, ".Rdata")
  filenamey = paste0("y_p10_n", n, "_seed", seed, ".Rdata")
  save(X_p10_n200, file=filenameX)
  save(y_p10_n200, file=filenamey)
